...
fig = px.line(x=tage, y=kurse, title="Kursverlauf 252 Handelstage", color_discrete_sequence=[farbe])
st.plotly_chart(fig, use_container_width=True)

with st.expander("💡 Was ist Volatilität?"):
    st.write("Volatilität beschreibt wie stark eine Aktie schwankt. " \
    "Eine hohe Volatilität bedeutet grosse, unvorhersehbare Kurssprünge nach oben und unten. " \
